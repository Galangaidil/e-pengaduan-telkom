...
export default {
    ...
    setup(props){
        const form = useForm({
            ...
            user_id: props.complaint.user_id,
            title: props.complaint.title,
            description: props.complaint.description,
            photo: props.complaint.photo,
            url: props.complaint.url
        });
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="max-w-md mx-auto">
                            <form @submit.prevent="form.put(route('complaints.update', form.id))">
                                <div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <FileInput id="photo" @preview-file="previewFile" accept="image/*" disabled />
                                    <InputError v-if="errors.photo" :message="errors.photo" class="mt-2"/>
                                </div>

                                <div class="mt-4">
                                    <img :src="form.url" class="rounded-lg">
                                </div>
